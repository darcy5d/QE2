-- Recreate ml_features table with correct foreign keys
-- Fixes: "foreign key mismatch" error by removing invalid FK to results table
...
CREATE TABLE ml_features (
    ...
    -- NEW: Discriminating features (18)
    ...
    trainer_hot_streak INTEGER,
    -- Auto timestamp
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    -- Only valid FK: race_id to races table
